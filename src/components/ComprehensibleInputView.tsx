              ...
              {isMobile ? (
                <>
                  ...
                  <motion.div
                    ...
                    className="fixed inset-0 bg-black z-[100] cursor-default"
                  />
                  ...
                  <motion.div
                    ...
                    className="fixed bottom-0 left-0 right-0 bg-white dark:bg-stone-900 border-t border-stone-200 dark:border-stone-800 rounded-t-3xl shadow-2xl z-[101] flex flex-col max-h-[85vh] outline-none p-6 space-y-4 font-sans text-stone-900 dark:text-stone-100 pb-safe"
                  >
                    {/* Handle & Header */}
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-xl bg-stone-900 dark:bg-stone-100 text-white dark:text-stone-950 text-xs font-black hover:opacity-90 transition text-center cursor-pointer"
                    >
                      Close
                    </button>
                  </motion.div>
                ...
                <>
                  ...
                  <motion.div
                    ...
                    className="fixed z-[101] bg-stone-900 dark:bg-stone-800 text-stone-100 p-4 rounded-2xl shadow-xl border border-stone-800 dark:border-stone-700 max-w-xs text-xs space-y-2 pointer-events-auto"
                    style={{
