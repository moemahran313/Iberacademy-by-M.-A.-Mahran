          ...
          {selectedToken && wordDef && (
            <div className="fixed inset-0 z-[100] lg:hidden pointer-events-none">
              ...
              <motion.div
                ...
                className="fixed inset-0 bg-black/60 backdrop-blur-xs z-[100] cursor-pointer pointer-events-auto"
              />
              ...
              <motion.div
                ...
                className="fixed bottom-0 left-0 right-0 bg-white dark:bg-stone-900 border-t border-stone-200 dark:border-stone-800 rounded-t-3xl shadow-2xl z-[101] flex flex-col max-h-[85vh] outline-none pointer-events-auto pb-safe"
              >
                ...
                <div className="relative py-3.5 border-b border-stone-100 dark:border-stone-800/80 flex items-center justify-between px-6 shrink-0">
                  <div
                    ...
                    className="w-12 h-1.5 bg-stone-300 dark:bg-stone-700 rounded-full absolute top-2 left-1/2 -translate-x-1/2 cursor-pointer hover:bg-stone-400 dark:hover:bg-stone-600 transition"
                  />
                ...
                <div className="p-6 overflow-y-auto space-y-5 pb-12 overscroll-contain">
                  {/* Word details */}
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="flex items-center gap-2">
